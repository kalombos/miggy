...
@pytest.mark.parametrize(
    ...
    # Changing name to new_name
    [
        (None, ['ALTER TABLE "book" RENAME COLUMN "author_id" TO "new_author_id"'], "new_author_id"),
        ("author_id", ['ALTER TABLE "book" RENAME COLUMN "author_id" TO "new_author_id"'], "new_author_id"),
        (
            "some_other_name",
            [],  # We shouldn't run alter query if don't know calculate the name of the new column
            "some_other_name",
